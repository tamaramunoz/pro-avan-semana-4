...
def inicializar_inventario():
    ...
    productos = [
        {"sabor": "Chocolate", "precio": 2500, "stock": 60},
        {"sabor": "Vainilla", "precio": 2000, "stock": 75},
        {"sabor": "Fresa", "precio": 3000, "stock": 70}
    ]
    return productos
...
def mostrar_sabores(lista_productos):
    ...
    for item in lista_productos:
        ...
        print(f"Sabor: {item['sabor']}, Precio: {item['precio']:.0f}, Stock: {item['stock']}")
    print("=================================================\n")
